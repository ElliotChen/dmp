...
public class BookStore {
	...
	static {
		bookList.add(new OffNoveBook("天龙八部",32.0f, "金庸"));
		bookList.add(new OffNoveBook("巴㴝圣母院",56.0f, "雨果"));
		bookList.add(new OffNoveBook("悲惨世界",35.0f, "雨果"));
		bookList.add(new OffNoveBook("金瓶梅",43.0f, "兰陵笑笑生"));
	}
